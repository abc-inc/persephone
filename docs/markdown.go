...
func WithBaseURL() glamour.TermRendererOption {
	return glamour.WithBaseURL("https://github.com/abc-inc/persephone/tree/master/docs/")
}
...
func Render(md string) (string, error) {
	...
	opts := []glamour.TermRendererOption{glamour.WithAutoStyle(), WithBaseURL(), WithoutIndentation(), WithWrap(width)}
